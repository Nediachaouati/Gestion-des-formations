...
<head>
    ...
    <title>{{ config('app.name', 'NewTechIt') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}"><h5><strong>{{ __('Se connecter') }}</strong></h5></a>
                                </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}"><h5><strong>{{ __('S inscrire') }}</strong></h5></a>
                                </li>
                            @endif
                        @else
